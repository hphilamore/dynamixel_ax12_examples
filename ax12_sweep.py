...
while True:
    ...
    if GPIO.input(26):
        ...
        time.sleep(1)
        Dynamixel.write(bytearray.fromhex("FF FF 01 05 03 1E 99 01 3E"))  # Move Servo with ID = 1 to position 205
        time.sleep(1)
        Dynamixel.write(bytearray.fromhex("FF FF 01 05 03 1E 66 02 70"))  # Move Servo with ID = 1 to position 205
        time.sleep(1)
        Dynamixel.write(bytearray.fromhex("FF FF 01 05 03 1E 33 03 A2"))  # Move Servo with ID = 1 to position 205
        time.sleep(1)
        Dynamixel.write(bytearray.fromhex("FF FF 01 05 03 1E 00 04 D4"))  # Move Servo with ID = 1 to position 205
        time.sleep(1)
        # GPIO.output(18,GPIO.LOW)
        # for line in Dynamixel.read():
        #     print(line)
